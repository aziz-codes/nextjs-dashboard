...
const Header = () => {
  ...
  return (
    <div className='top-0  flex flex-row h-10 mt-2
    items-center justify-between gap-3
       w-full mr-2' style={{zIndex:'0'}}>
        <Bars3Icon className='headerIcons text-blue-600 ml-2' title='toggle sidebar'
        onClick={()=>setActiveMenu((prevActiveMenu)=>!prevActiveMenu)} />
     <div className='flex gap-2'>
     <MagnifyingGlassIcon className='headerIcons'/>
     <div className='relative headerIcons'>
      <div className='absolute -top-2 z-50 -right-1 text-xs w-4 h-4 
